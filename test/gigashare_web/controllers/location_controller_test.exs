defmodule GigashareWeb.LocationControllerTest do
  use GigashareWeb.ConnCase

  alias Gigashare.AEMatch

  @create_attrs %{giga: 120.5, latitude: 120.5, locationName: "some locationName", longitude: 120.5, price: 42, time: 42}
  ...
  def fixture(:location) do
    {:ok, location} = AEMatch.create_location(@create_attrs)
    location
  end
